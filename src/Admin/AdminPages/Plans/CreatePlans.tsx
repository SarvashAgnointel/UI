        ...
        < div className="fixed flex justify-end gap-4 mr-[40px] items-end right-[0px] top-[-15px] z-20 " >
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen} >
            ...
            < DialogContent className="p-6 mx-auto" >
              ...
              < DialogDescription className="text-sm" > {discardMessage} </DialogDescription>
              < div className="flex justify-end gap-2 flex-wrap" >
                <Button variant="outline" className="px-4 py-2 w-auto" onClick={() => setIsDialogOpen(false)}>
                  Cancel
                </Button>
                < Button className="w-[60px] px-3 py-1 text-sm bg-red-500 text-white hover:bg-red-600" onClick={handleDiscard} >
                  Discard
                </Button>
              </div>
            </DialogContent>
